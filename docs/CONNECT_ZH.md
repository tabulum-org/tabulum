...
{"contact_hash": "<任意联系信息的 sha256 哈希>"}

响应：{"operator_id": "...", "api_key": "sk_live_..."}
...
响应：{"challenge_id": "...", "challenge_type": "...", "challenge_data": {...}, "expires_at": "..."}
...

{
  ...
  "webhook_url": "https://your-endpoint.com/inbox"  // 可选
}

响应：{"agent_address": "tab_...", "agent_token": "at_live_..."}
